...
import com.hcl.ers.online.ecommerce.cartoperation.model.Cart;
...
public class CartStore {
	...
	public Cart get(String cartId) {
    	...
    	N1qlQuery query = N1qlQuery.parameterized("select "+ bucketName + ".* from `" + bucketName + "` where docType='"+ DocTypes.CartAggregateView.name() +"' and id=$id", values, params);
