package com.hcl.ers.online.ecommerce.cartview.query;
...
import com.hcl.ers.online.ecommerce.cartview.graphql.CartSchemaBuilder;
...
public class CartQueryController {
	...
	@RequestMapping(value = "/ms/cartquery/view", method=RequestMethod.POST)
